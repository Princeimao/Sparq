...
export const comparisonData = {
    workspace: [
        ...
        { feature: "Team Members Invitation", free: false, normal: true, pro: true },
        { feature: "Workspace Analytics Dashboard", free: "Basic", normal: "Full", pro: "Advanced" },
    ],
    automation: [
        { feature: "Email Automation", free: false, normal: true, pro: true },
        { feature: "Custom Automation Rules", free: false, normal: true, pro: true },
        { feature: "Campaign Scheduling & Cron Jobs", free: "Standard Only", normal: "Flexible Scheduler", pro: "Real-time & Flex" },
        { feature: "Smart State-Machine Flow", free: "Linear Only", normal: "Configurable", pro: "Custom Dialogues" },
    ],
    integration: [
        { feature: "WhatsApp Cloud API Integration", free: "Simulated Webhooks", normal: "Direct Meta Cloud API", pro: "Direct Meta Cloud API" },
        { feature: "Stripe Payment Links", free: false, normal: true, pro: true },
        { feature: "API Access", free: false, normal: "Standard", pro: "High Rate-Limit" },
    ],
};
